...
RED.palette = (function () {
	...
	function addNodeType (nt, def) {
		...
		if (exclusion.indexOf(def.category) === -1) {
			...
			// just add the default code generator to all nodes without a "getSource" method.
			if (!def.defaults.hasOwnProperty("getSource")) {
				def.defaults["getSource"] = { "value": RED.generators.getSrcDefault };
			}
		}
	}
